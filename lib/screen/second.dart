...
class Secndpage extends StatefulWidget {
  ...
  Secndpage(this.name, this.singleValue, this.dropdownvalue, this.getcheck,
      this.ratting, this.date,
      {Key? key})
      : super(key: key);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Gender   :" + widget.singleValue),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("State  :" + widget.dropdownvalue),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Rating  :" + widget.ratting.toString()),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Date  :" + widget.date.toString()),
            ),
            // Padding(
            //   padding: const EdgeInsets.all(8.0),
            //   child: Text("Score  :" + widget.slidevalue.toString()),
            // ),
            const Padding(
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  itemCount: widget.getcheck.length,
                  itemBuilder: (BuildContext context, int index) {
                    return ListTile(
                        leading: const Icon(Icons.star),
                        title: Text(widget.getcheck[index]));
                  }),
            ),
          ],
        ),
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: Container(
            ...
            child: ListView(
              children: [
                DrawerHeader(decoration: BoxDecoration(), child: Text("dsaag")),
                ListTile(
                  title: Text("data"),
                ),
                ListTile(
                          ...
                          Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                      children: checkBox.map((hobby) {
                                    return CheckboxListTile(
                                        value: hobby["isChecked"],
                                        title: Text(hobby["name"]),
                                        onChanged: (newValue) {
                                          setState(() {
                                            checkBox[0]["isChecked"]= newValue;
                                           
                                          });
                                           print(checkBox[0]["isChecked"]);
